import type { EventRecord, EventSource, FeedState, Heartbeat } from "./schemas";
...
export interface MetricsJSONFormat {
  ...
  data: {
    ...
    websockets: {
      active: number;
      history?: { timestamp: string; count: number }[]; // Added to match usage in AdminDashboardResponse
    };
    feeds: {
